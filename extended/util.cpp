...
Index3::Index3(): Base(-1,-1,-1) {
}


Point3D::Point3D(): Base(0.,0.,0.) {
}
	
Vector3D::Vector3D(): Base(0.,0.,0.) {
}
...
double Vector3D::normalize() {
	...
	double x = (me[0] > 0.0) ? me[0] : -me[0];
	double y = (me[1] > 0.0) ? me[1] : -me[1];
	double z = (me[2] > 0.0) ? me[2] : -me[2];
...
Vector3D Vector3D::cross(const Vector3D& other) const
{
    const Vector3D& me = *this;
	return Vector3D(
			me[1]*other[2] - me[2]*other[1],
			me[2]*other[0] - me[0]*other[2],
			me[0]*other[1] - me[1]*other[0]);
}
